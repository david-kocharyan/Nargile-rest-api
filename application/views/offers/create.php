...
<div class="row">
	<div class="col-sm-12">
		<div class="white-box">
			...
			<form data-toggle="validator" action="<?php echo base_url() ?>admin/offers/store" method="post"
                ...
                <div class="form-group">
                    ...
                    <select name="type" required class="form-control" id="">
                        ...
                        <option value="2">Happy Hour Deal Offer</option>
                    </select>
                    <?php if (!empty(form_error('type'))) { ?>
                        <div class="help-block with-errors text-danger">
                            <?= form_error('type'); ?>
                ...
                <div class="form-group">
                    ...
                    <textarea required name="text" id="" cols="30" class="form-control" rows="10"></textarea>
                    <?php if (!empty(form_error('type'))) { ?>
                        <div class="help-block with-errors text-danger">
                            <?= form_error('type'); ?>
                        </div>
